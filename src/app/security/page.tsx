        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              Security is foundational to VGAC. We're building with enterprise-grade 
              security practices from day one. Full security documentation coming soon.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="mailto:aespira@vgac.cloud?subject=Security Inquiry" className="btn-primary">
                Security Questions
              </Link>
            </div>
          </motion.div>
