        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-plasma-500/10 border border-plasma-500/20 flex items-center justify-center">
              <CreditCard className="w-10 h-10 text-plasma-400" />
            </div>
            ...
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              We're currently in private beta. Early adopters get special pricing. 
              Reach out to learn more about our plans.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="mailto:aespira@vgac.cloud?subject=Pricing Inquiry" className="btn-primary">
                Contact for Pricing
              </Link>
            </div>
          </motion.div>
