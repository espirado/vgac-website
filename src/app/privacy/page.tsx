        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              Our full privacy policy is being drafted by legal counsel. 
              In short: we respect your data and will never sell it.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="mailto:aespira@vgac.cloud?subject=Privacy Question" className="btn-primary">
                Contact Us
              </Link>
            </div>
          </motion.div>
