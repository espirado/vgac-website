        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-electric-400/10 border border-electric-400/20 flex items-center justify-center">
              <Briefcase className="w-10 h-10 text-electric-400" />
            </div>
            ...
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              We're early stage and building something exciting. If you're passionate about 
              infrastructure, ML systems, or developer tools—let's talk.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="mailto:aespira@vgac.cloud?subject=Interested in Joining VGAC" className="btn-primary">
                Send Us Your Info
              </Link>
            </div>
          </motion.div>
