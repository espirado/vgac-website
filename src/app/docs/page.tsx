        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-electric-400/10 border border-electric-400/20 flex items-center justify-center">
              <FileText className="w-10 h-10 text-electric-400" />
            </div>
            ...
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              We're working on comprehensive documentation to help you get started with VGAC. 
              In the meantime, reach out to us directly for any questions.
            </p>
